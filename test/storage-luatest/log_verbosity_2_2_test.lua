...
test_group.test_recovery_do_not_spam_same_errors = function(g)
    ...
    g.replica_1_a:exec(function(bids, uuid)
        ...
        ivconst.RECOVERY_GET_STAT_TIMEOUT = 0.1
        box.begin()
...
test_group.test_rebalancer_not_log_disabled_storage = function(g)
    vtest.cluster_rebalancer_enable(g)
    g.replica_2_a:exec(function()
    ...
    local msg = "downloading rebalancer states.*STORAGE_IS_DISABLED"
    t.assert_not(g.replica_1_a:grep_log(msg))
    g.replica_2_a:exec(function()
